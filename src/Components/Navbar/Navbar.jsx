  ...
  return (
    <nav className='container'>
        ...
        <ul className={mobileMenu ? '' : 'hide-mobile-menu'}>
            ...
            {localStorage.getItem("token") ? <li><ScrollLink to='hero' smooth={true} offset={0} duration={500}><Link to='/menu'>Menu</Link></ScrollLink></li> : <li><ScrollLink to='services' smooth={true} offset={-260} duration={500}>Services</ScrollLink></li>}
            ...
            {localStorage.getItem("token") && <li><Link className='btn' to='/signout'>SignOut</Link></li>}
        </ul>
